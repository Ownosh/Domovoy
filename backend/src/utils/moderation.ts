...
const BASE_PROMPT = `Ты — ассистент модерации пользовательского контента в приложении для жителей многоквартирных домов. Тебе передаются поля «Тема» (короткий заголовок) и «Описание» (основной текст).
